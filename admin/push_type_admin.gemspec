...
Gem::Specification.new do |s|
  ...
  s.summary       = 'The admin user interface for PushType CMS.'
  s.description   = 'The admin user interface for PushType CMS. PushType is a new generation of content management system for Ruby on Rails.'
