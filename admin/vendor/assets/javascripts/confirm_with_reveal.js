    ...
    confirmWithReveal: function (options) {
      ...
      do_confirm = function ($el) {
        ...
        if (typeof el_options === "string" && el_options.length > 0) {
          return (
            ((_ref = $.rails) != null ? _ref.confirm : void 0) || window.confirm
          ).call(window, el_options)
        }
        option = function (name) {
          return el_options[name] || settings[name]
        }
        modal = $(
          "<div data-reveal class='reveal-modal " +
            option("modal_class") +
            "'>\n  <h2 data-confirm-title class='" +
            option("title_class") +
            "'></h2>\n  <p data-confirm-body class='" +
            option("body_class") +
            "'></p>\n  <div data-confirm-footer class='" +
            option("footer_class") +
            "'>\n    <a data-confirm-cancel class='" +
            option("cancel_class") +
            "'></a>\n  </div>\n</div>",
        )
        ...
        modal
          ...
          .on("closed.fndtn.reveal", function (e) {
            return modal.remove()
          })
        return false
      }
